...
void test_throttle_throttles() {
  ...
  rheo::State<int> valueSource(0);
  auto throttled = rheo::throttle(valueSource.sourceFn(), clockSource, rheo::mock_clock_ulong_millis::duration(10));
  ...
  rheo::mock_clock_ulong_millis::tick(11);
  valueSource.set(12);
